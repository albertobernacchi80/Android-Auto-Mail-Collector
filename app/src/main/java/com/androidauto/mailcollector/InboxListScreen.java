 ...
 * senza sottocartelle per account, come richiesto. Selezionare una riga con la rotella apre il
 * dettaglio di quel messaggio (MessageReadingScreen), non apre nessuna risposta.
 */
