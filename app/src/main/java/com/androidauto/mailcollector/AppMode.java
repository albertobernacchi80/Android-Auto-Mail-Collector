...
final class AppMode {
    ...
    private static final String KEY_READ_BODY = "read_body";
    ...
    boolean isReadBodyEnabled() {
        return prefs.getBoolean(KEY_READ_BODY, true);
    }

    void setReadBodyEnabled(boolean enabled) {
        prefs.edit().putBoolean(KEY_READ_BODY, enabled).apply();
    }
}
